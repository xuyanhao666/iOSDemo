...
-(CGRect)getViewFrame
{
    ...
    for (NSString *title in self.titleArray) {
        NSDictionary *dictionary = [NSDictionary dictionaryWithObjectsAndKeys:TITLE_FONT,NSFontAttributeName, nil];
//        CGFloat width =  [title sizeWithFont:TITLE_FONT constrainedToSize:CGSizeMake(300, 100) lineBreakMode:NSLineBreakByCharWrapping].width;
        CGFloat width = [title boundingRectWithSize:CGSizeMake(300, 100) options:NSStringDrawingUsesLineFragmentOrigin attributes:dictionary context:nil].size.width;
