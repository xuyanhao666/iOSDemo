...
-(void)setSegment {
    ...
    [self buttonList];
    //初始化
    LGSegment *segment = [[LGSegment alloc]initWithFrame:CGRectMake(50,  64, self.view.frame.size.width-100, LG_segmentH)];
...
-(void)setContentScrollView {
    ...
    UIScrollView *sv = [[UIScrollView alloc]initWithFrame:CGRectMake(0, 44, LG_ScreenW, LG_ScreenH)];
    ...
    for (int i=0; i<self.childViewControllers.count; i++) {
        ...
        vc.view.frame = CGRectMake(i * LG_ScreenW, -44, LG_ScreenW, LG_ScreenH-64);
